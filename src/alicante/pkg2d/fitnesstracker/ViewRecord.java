    ...
    public void displayRecords() {
        ...
        do {
            ...
            if (action < 1 || action > 3) {
                System.out.println("Invalid action, Please enter a value between 1 and 3.");
                continue; 
            }
                ...
                switch (action) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                    System.out.println("Exiting View Records...");
                    return;
            }

            System.out.print("Do you want to view more records? (yes/no): ");
            response = sc.next();
